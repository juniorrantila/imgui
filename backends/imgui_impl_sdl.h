...
IMGUI_IMPL_API bool     ImGui_ImplSDL2_InitForOpenGL(ImGuiContext* ctx, SDL_Window* window, void* sdl_gl_context);
IMGUI_IMPL_API bool     ImGui_ImplSDL2_InitForVulkan(ImGuiContext* ctx, SDL_Window* window);
